...
#ifndef YY_ED_SRC_CORE_DATA_PARSER_PARSER_TAB_HPP_INCLUDED
# define YY_ED_SRC_CORE_DATA_PARSER_PARSER_TAB_HPP_INCLUDED
/* Debug traces.  */
#ifndef EDDEBUG
# if defined YYDEBUG
#if YYDEBUG
...
#line 20 "src/core/data/parser/parser.y"
  ...
  DECL_NODE_NAMED(std::vector<Number>, NumberArray);
  ...
  using ScopeParamArray = std::vector<ScopeParam>;
  ...
  template<class T>
  static
  auto number_array_to_T_array(const EDSTYPE& edstype) -> std::vector<T>
  {
...
#line 258 "src/core/data/parser/parser.tab.hpp"
...
#endif /* !YY_ED_SRC_CORE_DATA_PARSER_PARSER_TAB_HPP_INCLUDED  */
